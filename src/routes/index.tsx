...
function Index() {
  ...
  return <main className="bg-background text-foreground">
    ...
    <section id="home" className="grain relative flex min-h-[92svh] items-end overflow-hidden bg-primary text-primary-foreground">
