...
function Index() {
  ...
  useEffect(() => {
    ...
    const updateHeaderHeight = () => {
      document.documentElement.style.setProperty("--germinnaa-header-height", `${headerBar.getBoundingClientRect().height}px`);
    };
    updateHeaderHeight();
    ...
    return () => {
      ...
      document.documentElement.style.removeProperty("--germinnaa-header-height");
    };
  }, []);
  ...
  return <main className="bg-background text-foreground">
    ...
    <section id="home" className="hero-viewport grain relative overflow-hidden bg-primary text-primary-foreground">
    ...
    <section className="relative min-h-[62svh] overflow-hidden lg:min-h-[70svh]"><img src={nightExteriorImage} alt="Germinnaa's illuminated green entrance and striped awnings at night" width="768" height="1024" loading="lazy" className="absolute inset-0 h-full w-full object-cover object-center sm:object-[center_22%]"/><div className="absolute inset-0 bg-primary/38"/><div className="relative z-10 flex min-h-[62svh] items-center justify-center px-5 text-center text-primary-foreground lg:min-h-[70svh]"><h2 className="text-5xl leading-[.94] sm:text-8xl lg:text-[92px]">Come Hungry.<br/><em>Leave With a Memory.</em></h2></div></section>
